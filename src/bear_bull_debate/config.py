...
class Settings:
    max_rounds: int = 2
    bear_model: str = "deepseek-v4-flash"
    bull_model: str = "deepseek-v4-flash"
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            bear_model=os.getenv("BEAR_MODEL", "deepseek-v4-flash"),
            bull_model=os.getenv("BULL_MODEL", "deepseek-v4-flash"),
